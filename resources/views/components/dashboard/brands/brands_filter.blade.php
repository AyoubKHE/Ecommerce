                    ...
                    <div class="row" style="margin-bottom: 10px">
                        ...
                        <div class="col-5">
                            ...
                            <div class="row d-flex align-items-center">
                                ...
                                <div class="col-2">
                                    <label for="brand-name" class="form-label my-form-label"
                                ...
                                <div class="col-1" style="padding-left: 0px;">
                                    <div class="my-tooltip" id="ep-brand-name" style="display: none">
                                        <div class="icon">!</div>
                                        <div class="my-tooltiptext" id="ep-brand-name-text"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row d-flex align-items-center">
                                <div class="col-12" style="padding-right: 10px;">
                                    <textarea class="form-control" name="brand_description" id="brand-description"></textarea>
                                </div>

                                <div class="col-1" style="padding-left: 0px;">
                                    <div class="my-tooltip" id="ep-brand-description" style="display: none">
                                        <div class="icon">!</div>
                                        <div class="my-tooltiptext" id="ep-brand-description-text"></div>
                                    </div>
                                </div>
                            </div>
