    ...
    <section class="mt-5 container ">
        ...
        <div class="row g-md-8 mt-4">
            ...
            <div class="col-12 col-lg-6 col-xl-7">
                ...
                <div class="checkout-panel">
                    <h5 class="title-checkout">Mode de livraison</h5>
                    ...
                    <div class="form-check form-group form-check-custom form-radio-custom mb-3">
                        ...
                        <label class="form-check-label" for="checkoutShippingMethodOne">
                            <span class="d-flex justify-content-between align-items-start w-100">
                                <span>
                                    <span class="mb-0 fw-bolder d-block">Cliquez et collectez l'expédition</span>
                    ...
                    <div class="form-check form-group form-check-custom form-radio-custom mb-3">
                        ...
                        <label class="form-check-label" for="checkoutShippingMethodTwo">
                            <span class="d-flex justify-content-between align-items-start">
                                <span>
                                    <span class="mb-0 fw-bolder d-block">UPS le lendemain</span>
                                    <small class="fw-bolder">Pour toute commande passée avant 13h du lundi au jeudi</small>
                                </span>
                                <span class="small fw-bolder text-uppercase">500 DA</span>
                            </span>
                        </label>
                    </div>
                        ...
                        @foreach ($data['cartData']['items'] as $cartItem)
                            <div class="d-none d-md-flex justify-content-between align-items-start py-2">
                                <div class="d-flex flex-grow-1 justify-content-start align-items-start">
                                    ...
                                    <div>
                                        <p class="mb-1 fs-6 fw-bolder">{{ $cartItem['variation']['product']['name'] }}</p>
                                        ...
                                        <span class="fs-xs text-uppercase fw-bolder text-muted">{{ $options }}</span>
