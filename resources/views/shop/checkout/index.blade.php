                ...
                <div class="checkout-panel">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="country" class="form-label">Wilaya</label>
                                <select class="form-select" id="wilayas-select">
                                    <option value="">Veuillez sélectionner...</option>
                                    @foreach ($data['wilayas'] as $wilaya)
                                        <option data-wilaya-id="{{ $wilaya["id"] }}" value="{{ $wilaya["name"] }}" {{ $wilaya["name"] == "Béjaïa" ? "selected" : "" }}>{{ $wilaya["name"] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-select" id="communes-select">
                                    <option value="">Veuillez sélectionner...</option>
                ...
                <div class="checkout-panel">
                    ...
                    <div class="form-check form-group form-check-custom form-radio-custom mb-3">
                        <input class="form-check-input" type="radio" name="shipping_method"
                            id="shipping-method-1" checked value="from_store" data-price="0">
                    ...
                    <div class="form-check form-group form-check-custom form-radio-custom mb-3">
                        <input class="form-check-input" type="radio" name="shipping_method"
                            id="shipping-method-2" value="yalidine" data-price="300">
                ...
                <div class="bg-light p-4 sticky-md-top top-5">
                            ...
                            @foreach ($data['cartData']['items'] as $cartItem)
                                <div class="d-none d-md-flex justify-content-between align-items-start py-2">
                                    <div class="d-flex flex-grow-1 justify-content-start align-items-start">
                                        ...
                                        <div>
                                            <p class="mb-1 fs-6 fw-bolder">{{ $cartItem['variation']['product']['name'] }}
                                            </p>
                                            ...
                                            @php
                                                ...
                                                foreach (
                                                    ...
                                                    $options = $options . $attribute_option['option']['value'] . ' / ';
                                                }
                    ...
                    <div class="py-3 border-bottom">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <p class="m-0 fs-5 fw-bold" id="price-total">{{ $data['cartData'] != null ? $data['cartData']['total_price'] : 0.0 }} DA</p>
                        </div>
                    </div>
                    {{-- <div class="py-3 border-bottom">
                    ...
                    <div class="form-group form-check my-4">
                        ...
                        <label class="form-check-label fw-bolder" for="accept-terms">J'accepte les conditions générales
                            d'Eleganza <a href="#">termes &
                                conditions</a></label>
                    </div>
                    <a href="#" class="btn btn-dark w-100" role="button">Valider la commande</a>
                </div>
            </div>
            <!-- /Checkout Panel Summary -->
        </div>
