...
class BackupService
{
    ...
    public static function createImagesBackup(string $tableName, int $id): bool
    {
    ...
    public static function deleteImagesBackup(string $tableName, int $id)
    {
        $backupFolder = "public/" . $tableName . "/temp/id_" . $id;
        Storage::deleteDirectory($backupFolder);
    }

    public static function makeImagesRestoration(string $tableName, int $id)
    {
        $backupFolder = "public/" . $tableName . "/temp/id_" . $id;
        $sourceFolder = "public/" . $tableName . "/id_" . $id;
